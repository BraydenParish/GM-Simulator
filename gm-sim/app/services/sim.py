...
def simulate_game(home_team_id: int, away_team_id: int, home_rating: float, away_rating: float, seed: int = None):
    if seed is not None:
        random.seed(seed)
    ...
    box = {
        "home_qb": {"yds": random.randint(180, 320), "td": random.randint(1, 3), "int": random.randint(0, 2)},
        "away_qb": {"yds": random.randint(180, 320), "td": random.randint(1, 3), "int": random.randint(0, 2)},
